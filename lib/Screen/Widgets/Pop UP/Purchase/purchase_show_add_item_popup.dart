...
class PurchaseShowAddItemPopUp extends StatefulWidget {
  const PurchaseShowAddItemPopUp({Key? key}) : super(key: key);

  @override
  State<PurchaseShowAddItemPopUp> createState() => _ShowAddItemPopUpState();
}

class _ShowAddItemPopUpState extends State<PurchaseShowAddItemPopUp> {
                        ...
                        child: Column(
                          children: [
                            Column(
                              ...
                              children: [
                                Icon(MdiIcons.cloudUpload, size: 50.0, color: kLitGreyColor).onTap(() => pickImage(ImageSource.gallery)),
                              ],
                            ),
                            const SizedBox(height: 5.0),
                            RichText(

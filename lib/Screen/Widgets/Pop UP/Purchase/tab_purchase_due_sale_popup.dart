...
class TabPurchaseDueSalePopUp extends StatefulWidget {
  const TabPurchaseDueSalePopUp({Key? key}) : super(key: key);

  @override
  State<TabPurchaseDueSalePopUp> createState() => _TabPurchaseDueSalePopUpState();
}

class _TabPurchaseDueSalePopUpState extends State<TabPurchaseDueSalePopUp> {
  List<String> userId = [
    'Select Customer',
    'Shahidul\n017XXXXXXXX',
    'Prince\n017XXXXXXXX',

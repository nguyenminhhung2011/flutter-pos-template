                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const Spacer(),
                                          Text(
                                            '$currency ${myFormat.format(double.tryParse(getTotalAmount().toString()) ?? 0)}',
                                            style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                          ),
                                        ],
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const Spacer(),
                                          Text(
                                            '$currency ${myFormat.format(double.tryParse(widget.transitionModel.discountAmount.toString()) ?? 0)}',
                                            style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                          ),
                                        ],
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const Spacer(),
                                          Text(
                                            '$currency ${myFormat.format(double.tryParse(widget.transitionModel.totalAmount.toString()) ?? 0)}',
                                            style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                          ),
                                        ],
                                      ),

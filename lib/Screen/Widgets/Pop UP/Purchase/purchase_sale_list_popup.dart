...
class PurchaseSaleListPopUp extends StatefulWidget {
  const PurchaseSaleListPopUp({Key? key}) : super(key: key);

  @override
  State<PurchaseSaleListPopUp> createState() => _PurchaseSaleListPopUpState();
}

class _PurchaseSaleListPopUpState extends State<PurchaseSaleListPopUp> {
  List<String> userId = [
    'Select Customer',
    'Shahidul\n017XXXXXXXX',
    'Prince\n017XXXXXXXX',
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  lang.S.of(context).yourAllSaleList,
                  ...
                  child: FormField(
                    builder: (FormFieldState<dynamic> field) {
                      return InputDecorator(
                        ...
                        child: Text(
                          selectedDueDate.day.toString() + '/' + selectedDueDate.month.toString() + '/' + selectedDueDate.year.toString(),

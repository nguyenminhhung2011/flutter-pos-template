...
//                                   ),
//                                   DataCell(
//                                     Text('\$ ${widget.transitionModel.productList?[index].productPurchasePrice ?? ''}'),
//                                   ),
//                                   DataCell(
//                                     Text(widget.transitionModel.productList?[index].productStock.toString() ?? ''),
//                                   ),
//                                   DataCell(
//                                     Text('\$ ${double.parse(widget.transitionModel.productList![index].productPurchasePrice) * widget.transitionModel.productList![index].productStock.toDouble()}'),
//                                   ),
//                                 ],
//                               )),
//                         ),
